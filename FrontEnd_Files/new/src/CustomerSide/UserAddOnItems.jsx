...
// const UserAddOnItems = (addOns) => {
//   return (
//     <div>
//       {addOns.items.map((allAddOns) => {

//         const [data, speed, ...remainingSubstringArray] = allAddOns.planDetails.split(" ");
...
//           {/* <PlanItems
//             id={allAddOns.planId}
//             type={allAddOns.planType}
//             name={allAddOns.planName}
//             validity={allAddOns.planValidity}
//             data={formattedData}
//             speed={formattedSpeed}
//             note={note}
//             price={allAddOns.planPrice}
//           /> */}
//         );
//       })}
//     </div>
